...
object MinimalCrossDeviceInsertedSetWorkoutStoreFixture {
    ...
    fun setupWorkoutStore(context: Context) {
        ...
        val exercise = Exercise(
            ...
            notes = "Base two-set workout for in-session inserted set sync coverage",
            sets = listOf(
        ...
        val workout = Workout(
            id = WORKOUT_ID,
            name = WORKOUT_NAME,
            description = "Minimal inserted-set cross-device sync workout",
