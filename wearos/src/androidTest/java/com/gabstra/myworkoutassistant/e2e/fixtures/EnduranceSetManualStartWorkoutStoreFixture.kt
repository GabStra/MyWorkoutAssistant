...
/**
 * Fixture for creating a workout store with a workout that has an EnduranceSet exercise
 * with autoStart = false and countdown disabled. This is used for tests that verify manual start.
 */
object EnduranceSetManualStartWorkoutStoreFixture {
