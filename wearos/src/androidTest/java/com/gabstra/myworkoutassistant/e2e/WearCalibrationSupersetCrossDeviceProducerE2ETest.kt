...
import com.gabstra.myworkoutassistant.e2e.fixtures.CalibrationSupersetCrossDeviceWorkoutStoreFixture
...
class WearCalibrationSupersetCrossDeviceProducerE2ETest : WearBaseE2ETest() {
    ...
    override fun prepareAppStateBeforeLaunch() {
        ...
        CalibrationSupersetCrossDeviceWorkoutStoreFixture.setupWorkoutStore(context)
    }
    ...
    @Test
    fun completeTwoExerciseCalibrationSuperset_syncsCompleteHistoryToPhone() {
        startWorkout(CalibrationSupersetCrossDeviceWorkoutStoreFixture.WORKOUT_NAME)
        flowHelper.completeCalibrationSupersetWorkoutFlow(expectedCalibrationCount = 2)
