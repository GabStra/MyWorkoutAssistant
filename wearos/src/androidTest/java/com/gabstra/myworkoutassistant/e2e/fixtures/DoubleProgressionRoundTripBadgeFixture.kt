...
object DoubleProgressionRoundTripBadgeFixture {
    const val WORKOUT_NAME = "Double Progression Round Trip Badge Workout"
    const val EXERCISE_NAME = "Round Trip Press"
    ...
    const val EXPECTED_BADGE_TEXT = "+1 reps"
    ...
    fun createWorkoutStore(): WorkoutStore {
        ...
        val exercise = Exercise(
            ...
            sets = listOf(
                WeightSet(id = SET_ID, reps = PHONE_TEMPLATE_REPS, weight = TEMPLATE_WEIGHT)
            ),
