...
foreach ($name in @('Get-ExistingSelectedSummary', 'Test-MovementSkeletonIntegrity', 'Test-BakeStageReady')) {
...
try {
    ...
    $item = [pscustomobject]@{ exerciseWorkspace=$fixture; bakeWorkspace=(Join-Path $fixture 'bake'); exerciseSlug='squat'; exerciseName='Squat' }
