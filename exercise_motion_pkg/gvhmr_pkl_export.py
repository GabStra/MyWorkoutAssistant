...
def export_gvhmr_results_pkl(results_pt: Path, output_pkl: Path) -> dict[str, object]:
    ...
    trans_world = params["transl"].reshape(global_orient.shape[0], 3)
...
def main() -> None:
    ...
    summary = export_gvhmr_results_pkl(args.results, args.output_pkl)
