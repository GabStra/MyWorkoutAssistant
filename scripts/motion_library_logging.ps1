...
function ConvertTo-MotionLibraryReasons {
    ...
    $labels = @{
        ...
        fit_input_structurally_conflicted = 'Fit targets are anatomically incompatible with the rig; skipped instead of burning the fit budget.'
        ...
        physical_pose_constraint_violation = 'The pose violates anatomical or physical constraints.'
        controlled_motion_fit_rejected = 'The motion fit failed its validation checks.'
        source_confirmed_baseline_support_drift = 'The planted foot drifts from its source-confirmed position.'
        source_confirmed_support_unrepaired = 'The planted-foot drift could not be repaired.'
        support_lock_baseline_safety_failed = 'The support repair would have distorted the pose.'
        materialized_loop_bridge_pose_mismatch = 'The loop wrap pose does not match the source.'
        loop_bridge_pose_mismatch_penalty = 'Penalty: the loop wrap pose does not match the source.'
        loop_bridge_mismatch_ignored_loop_not_required = 'Loop wrap pose mismatch noted; no seamless loop is required.'
        supported_body_moves = 'A supported body part moves when it should stay planted.'
        support_surface_geometry_mismatch = 'The support surface does not match the source.'
        materialized_paired_hands_distortion = 'The paired hands are distorted relative to each other.'
        paired_hands_distortion_penalty = 'Penalty: the paired hands are distorted.'
        postprocess_body_rotation_jitter = 'Processing introduced body rotation jitter.'
        root_translation_discontinuity = 'The root translation jumps between frames.'
        materialized_target_motion_not_preserved_from_source = 'The target motion is not preserved from the source.'
        materialized_low_target_motion_observability = 'The target motion is not clearly observable.'
        materialized_low_parent_phase_motion_capture = 'The source clip captures too little of the movement phase.'
        weak_lower_body_motion_penalty = 'Penalty: the lower-body motion is weak.'
        bake_missing_artifact = 'The bake did not produce a reviewable artifact.'
        materialized_source_pose_fidelity_unavailable = 'Source pose fidelity could not be evaluated.'
        playback_validation_failed = 'The fitted movement failed playback validation.'
        incompatible_stationary_contact_anchors = 'Stationary contact anchors are incompatible for fitting.'
        source_cycle_preflight_rejected = 'The fit cycle preflight rejected the source window.'
        candidate_failed = 'The candidate failed during processing.'
        retained_selection_artifacts_missing = 'No retained movement artifacts were found to revalidate.'
        retained_selected_artifact_rejected_under_current_policy = 'The retained movement failed the current validation policy.'
    }
