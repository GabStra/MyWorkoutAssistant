...
object ResumeCrossDevicePhoneWorkoutStoreFixture {
    ...
    const val EXPECTED_TOTAL_SET_COUNT = 22
        ...
        val workout = Workout(
            ...
            workoutComponents = listOf(
                Exercise(
                    ...
                    sets = listOf(
                        TimedDurationSet(
                            UUID.fromString("05de08a7-67a6-4a82-8b43-92ce1a78292d"),
                            300_000,
                            autoStart = true,
                            autoStop = true
                        )
    ...
    fun createIncompleteHistory(): WorkoutHistory {
    ...
    fun createSeededSetHistories(): List<SetHistory> {
        val start = LocalDateTime.of(2026, 4, 27, 18, 56, 19)
        return buildList {
            add(
                setHistory(
            ...
            add(weightHistory(BACK_SQUAT_EXERCISE_ID, UUID.fromString("e4d647bc-bc1c-456b-8ced-10bd62d05fe4"), 0u, start.plusMinutes(6), 5, 20.0, SetSubCategory.WarmupSet))
            add(weightHistory(BACK_SQUAT_EXERCISE_ID, UUID.fromString("e79ff242-71a9-4c3d-8db4-031a6c227ee9"), 2u, start.plusMinutes(8), 4, 40.0, SetSubCategory.WarmupSet))
            add(weightHistory(BACK_SQUAT_EXERCISE_ID, UUID.fromString("5050629e-f87b-4824-9df6-560d1b4ac77f"), 4u, start.plusMinutes(10), 2, 60.0, SetSubCategory.WarmupSet))
            add(weightHistory(BACK_SQUAT_EXERCISE_ID, UUID.fromString("b06747fe-bb01-4637-97bc-b8c5a61669a9"), 6u, start.plusMinutes(12), 8, 100.0, SetSubCategory.WorkSet))
            add(weightHistory(BACK_SQUAT_EXERCISE_ID, UUID.fromString("8d70f241-b84a-4a9c-873b-3b7b3af87a07"), 8u, start.plusMinutes(15), 8, 100.0, SetSubCategory.WorkSet))
            add(weightHistory(BACK_SQUAT_EXERCISE_ID, UUID.fromString("3525c514-9483-4bfc-a888-ab6d63ac0833"), 10u, start.plusMinutes(18), 8, 100.0, SetSubCategory.WorkSet))

            add(weightHistory(BENCH_EXERCISE_ID, UUID.fromString("03e5a587-0b28-4eea-8988-6d20301593df"), 0u, start.plusMinutes(22), 5, 20.0, SetSubCategory.WarmupSet))
            add(weightHistory(BENCH_EXERCISE_ID, UUID.fromString("4b605e0e-106e-4480-855d-391fd67ec4a8"), 2u, start.plusMinutes(24), 4, 35.0, SetSubCategory.WarmupSet))
            add(weightHistory(BENCH_EXERCISE_ID, UUID.fromString("d337243a-fb4f-4e48-bcd8-88cb1f73bc2d"), 4u, start.plusMinutes(26), 2, 50.0, SetSubCategory.WarmupSet))
            add(weightHistory(BENCH_EXERCISE_ID, UUID.fromString("ead17a6d-d3ed-402a-ab71-bd683b530105"), 6u, start.plusMinutes(28), 8, 80.0, SetSubCategory.WorkSet))
            add(weightHistory(BENCH_EXERCISE_ID, UUID.fromString("3b7e3899-aca7-4536-97b3-6c83bdd895df"), 8u, start.plusMinutes(31), 8, 80.0, SetSubCategory.WorkSet))
            add(weightHistory(BENCH_EXERCISE_ID, UUID.fromString("02196bbe-97df-42e2-b909-a630f73f6b8d"), 10u, start.plusMinutes(34), 8, 80.0, SetSubCategory.WorkSet))

            add(bodyWeightHistory(PULLUPS_EXERCISE_ID, UUID.fromString("0ec620b8-8e35-4e28-b8f6-1f836664bfed"), 0u, start.plusMinutes(38), 8, 5.0))
            add(bodyWeightHistory(PULLUPS_EXERCISE_ID, UUID.fromString("a304e1fe-b55d-40ec-89a0-637ff78c2695"), 2u, start.plusMinutes(41), 8, 5.0))
            add(bodyWeightHistory(PULLUPS_EXERCISE_ID, UUID.fromString("a0bf7c38-ecbd-4582-a625-3e81fe48cc1b"), 4u, start.plusMinutes(44), 8, 5.0))

            add(weightHistory(ROW_EXERCISE_ID, UUID.fromString("243f5cc1-c2cd-4de3-b343-e561f8512301"), 0u, start.plusMinutes(47), 10, 50.0, SetSubCategory.WorkSet))
            add(weightHistory(ROW_EXERCISE_ID, UUID.fromString("3b45b875-c482-4c81-9b2b-126d0fda9196"), 2u, start.plusMinutes(50), 10, 50.0, SetSubCategory.WorkSet))
            add(weightHistory(ROW_EXERCISE_ID, UUID.fromString("e16aa164-0df6-44be-93a4-e3ee529b5648"), 4u, start.plusMinutes(53), 10, 50.0, SetSubCategory.WorkSet))
        }
    }
