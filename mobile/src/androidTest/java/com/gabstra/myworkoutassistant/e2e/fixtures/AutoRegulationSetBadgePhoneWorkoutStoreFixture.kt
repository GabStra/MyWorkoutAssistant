...
object AutoRegulationSetBadgePhoneWorkoutStoreFixture {
    ...
    fun createWorkoutStore(): WorkoutStore {
        val exercise = Exercise(
            ...
            enabled = true,
            name = EXERCISE_NAME,
            notes = "Phone-side auto-regulation badge verification",
            sets = listOf(
        ...
        return WorkoutStore(
            workouts = listOf(
                Workout(
                    id = WORKOUT_ID,
                    name = WORKOUT_NAME,
                    description = "Phone-side auto-regulation badge verification workout",
